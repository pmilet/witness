...
cat > Witness.Infrastructure/Configuration/WitnessOptions.cs << 'EOF'
...
cat > Witness.Infrastructure/Services/HttpExecutorService.cs << 'EOF'
...
public sealed class HttpExecutorService : IHttpExecutor
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            {
                _httpClient.DefaultRequestHandler.AllowAutoRedirect = false;
